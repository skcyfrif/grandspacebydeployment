document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("http://88.222.241.45:9080/api/project/projects/completed/count")
    // fetch("http://localhost:9090/api/project/projects/completed/count")
        .then(response => {
            if (!response.ok) {
...
async function fetchProjects() {
    try {
        ...
        const response = await fetch('http://88.222.241.45:9080/api/project/completed-projects');
        // const response = await fetch('http://localhost:9090/api/project/completed-projects');
